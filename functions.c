 ...
 * @types: ariable argument list that contains
 * the arguments that were passed to the function.
 * @buffer: Buffer array to handle print
 * @flags:  Calculates active flags
 * @width: get width.
...
/************************* PRINT BINARY *************************/
/**
 * print_binary - Print the binary representation of a number to buffer
 * @types: variable argument list that contains
 * the arguments that were passed to the function.
 * @buffer: Buffer array to handle print
 * @flags:  Calculates active flags
 ...
 * @precision: Precision specification
 * @size: Size specifier
 * Return: number of Bits that were written to the buffer.
 */
